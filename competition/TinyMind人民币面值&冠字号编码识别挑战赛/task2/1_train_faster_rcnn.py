...
def get_dataset(dataset, args):
    if dataset.lower() == 'voc':
        ...
        val_dataset = VOCLike(root='./',
            splits=[(2007, 'val')])
        val_metric = VOC07MApMetric(iou_thresh=0.9, class_names=val_dataset.classes)
...
# python3 1_train_faster_rcnn.py --gpus 0,1 --dataset voc --network resnet50_v1b
# python3 1_train_faster_rcnn.py --gpus 0,1 --dataset voc --network resnet101_v1d
